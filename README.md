...
- **Peripheral:** Mikrodenetleyicinin içinde bulunan **GPIO**, **UART**, **SPI**, **I2C**, **Timer**, **ADC** gibi çevresel birimlerdir. Cihazın dış ortamlarlar iletişiminde kullanılırlar. Her biri ayrı bir periferik modül olarak kabul edilir.
